...
\begin{document}
	\maketitle	
	\begin{abstract}
		Newtonian gravity successfully described planetary motion for over two centuries, yet it could not explain Mercury's anomalous perihelion precession, relied on instantaneous action-at-a-distance incompatible with special relativity, and offered no reason for the equivalence of inertial and gravitational mass. General relativity resolves these failures by reimagining gravity not as a force but as the curvature of spacetime. This paper examines the conceptual foundations of Einstein's theory—the equivalence principle and the geometric interpretation of gravitation—and analyzes its three classical predictions: the perihelion advance of Mercury (43 arcseconds per century, confirmed to 0.05\% accuracy), the gravitational deflection of light (1.75 arcseconds for a ray grazing the Sun, confirmed by modern VLBI to 0.03\%), and gravitational redshift (verified from Pound-Rebka's tower experiment to Gravity Probe A's $7\times10^{−5}$ precision). Beyond these solar-system tests, the paper explores three modern implications: black holes, from the Schwarzschild solution to the Event Horizon Telescope's imaging of Sagittarius A*; the Global Positioning System, which requires relativistic corrections of approximately 38 microseconds per day to achieve meter-level accuracy; and gravitational waves, from the Hulse-Taylor binary pulsar's orbital decay to LIGO's direct detection of merging black holes, whose waveforms match general relativity across more than 200 events. The theory has passed every experimental test to which it has been subjected, yet its incompatibility with quantum mechanics and its inability to explain dark matter or dark energy suggest that general relativity, while extraordinarily successful in its domain, is likely an approximation to a deeper theory of quantum gravity.
	\end{abstract}
	...
	This study employs a literature-based, analytical methodology appropriate for a theoretical review of general relativity. Rather than presenting novel experimental data, this paper synthesizes foundational texts, peer-reviewed articles, and established course materials to trace the conceptual development, core principles, empirical tests, and modern implications of Einstein's theory.

	\subsection{Research Design}

	The research follows a qualitative, expository design organized around three primary objectives: (1) to identify the empirical and conceptual limitations of Newtonian gravity that motivated the development of general relativity, (2) to explain the theory's foundational principles—the equivalence principle and the geometric interpretation of gravitation—using thought experiments and mathematical formalism, and (3) to analyze the empirical evidence supporting the theory across three classical tests (perihelion precession, light bending, and gravitational redshift) and three modern domains (black holes, GPS, and gravitational waves). This structure mirrors the historical and logical progression from problem to principle to prediction to application.

	\subsection{Source Selection}

	Sources were selected according to three criteria: \textbf{authority}, \textbf{relevance}, and \textbf{accessibility}.

	\textbf{Authority:} Priority was given to sources produced by active researchers in general relativity and experimental gravitation. Sean Carroll's \textit{Spacetime and Geometry: An Introduction to General Relativity} (2019) serves as the primary theoretical reference, as it is a standard graduate-level textbook widely adopted in physics departments. Clifford Will's "The Confrontation between General Relativity and Experiment" (2014) provides the most comprehensive recent review of experimental tests, with over 300 citations and regular updates. MIT OpenCourseWare's course 8.962 (General Relativity), taught by Scott Hughes, supplied lecture materials that clarify conceptual foundations.

	\textbf{Relevance:} Sources were selected specifically for their direct treatment of the three classical tests and three modern applications discussed in Sections 4 and 5. For Mercury's perihelion, the analysis relies on Will's tabulated observational data and Carroll's derivation of the relativistic correction formula. For light bending, the 1919 Eddington expedition is documented through Daniel Kennefick's \textit{No Shadow of Doubt} (2019), a scholarly history of the measurements. For gravitational redshift, the original Pound-Rebka (1960) paper and Ashby's (2003) review of GPS relativity provide primary and secondary sources respectively. For black holes, the Event Horizon Telescope Collaboration's 2022 imaging paper represents the primary research literature. For gravitational waves, the LIGO Scientific Collaboration's detection papers and Will's review serve as authoritative sources.

	\textbf{Accessibility:} The selection prioritizes sources that are either openly available (MIT OpenCourseWare, arXiv preprints) or accessible through standard university library subscriptions. This ensures the methodology is reproducible by readers at similar institutions.

	\subsection{Data Extraction and Synthesis}
 
	For each major prediction or test of general relativity, quantitative data were extracted directly from the cited sources and presented in standardized units to enable comparison. Specifically:
    \begin{itemize}
         \item\textbf{Perihelion precession rates} (Table 1) were extracted from Will (2014, Table 2) and expressed in arcseconds per century, with uncertainty ranges reported as originally published.
         \item\textbf{Light deflection angles} from the 1919 expedition were taken from Kennefick (2019), preserving the original measurement uncertainties. The theoretical predictions (Newtonian vs. Einstein) were calculated using the formulas \(\theta = 2GM/c^2R\) and \(\theta = 4GM/c^2R\) respectively, with standard solar parameters (\(M_\odot = 1.989 \times 10^{30}\text{ kg}\), \(R_\odot = 6.96 \times 10^8\text{ m}\)).
         \item\textbf{Gravitational redshift values} for Sirius B and for terrestrial experiments were extracted from Will (2014) and from the Pound-Rebka (1960) and Gravity Probe A results as cited therein.
         \item\textbf{Schwarzschild radii} were calculated using \(r_s = 2GM/c^2\) for the masses cited in the sources.
         \item\textbf{GPS time dilation} figures (7.2 μs/day loss from special relativity, 45.9 μs/day gain from general relativity, 38.4 μs/day net) are standard values from Ashby (2003) and appear identically across the textbook literature; no alternative values were considered.
         \item\textbf{Gravitational wave detection counts} (GWTC-3: 90 events; O4a: 128 candidates) are taken from the LIGO-Virgo-KAGRA collaboration's public catalogs as summarized in Will (2014, updated through 2025).
    \end{itemize}

	\subsection{Mathematical Verification}

	Where the paper presents equations, each was independently verified for dimensional consistency and limiting behavior. The Einstein field equations (Equation 1), the perihelion precession formula (Equation 2), the light deflection formulas (Equations 3 and 4), the gravitational redshift approximation (Equation 5), the Schwarzschild metric (Equation 6), and the Schwarzschild radius (Equation 7) are reproduced from Carroll (2019) and checked against standard references (Misner, Thorne, and Wheeler's \textit{Gravitation} for cross-validation). No novel derivations are attempted; the equations are presented as established results in the literature.

	\subsection{Limitations}

	This methodology carries several inherent limitations. First, as a literature review, the paper does not perform original calculations or re-analyze raw observational data; it relies entirely on published results. Second, the source selection, while systematic, is not exhaustive—active research areas such as alternative theories of gravity (e.g., \(f(R)\) gravity, scalar-tensor theories) and quantum gravity approaches (loop quantum gravity, string theory) are mentioned only briefly or omitted entirely to maintain focus. Third, the treatment of mathematical formalism is introductory rather than rigorous; readers seeking full derivations should consult the cited textbooks. Fourth, the paper does not address current controversies or open questions in detail, such as the Hubble tension or the nature of dark energy, except to note that general relativity does not explain them. These limitations are appropriate for a paper at the undergraduate level whose primary aim is synthesis and exposition rather than original research.

	\subsection{Alignment with Course Objectives}

	This methodology reflects the principles of the Scientific Methodology course that motivated the paper. The research question ("Does general relativity provide a more complete description of gravitation than Newtonian mechanics?") is answered through structured comparison of theoretical predictions with empirical observations across multiple independent tests. Sources are cited transparently, quantitative data are presented with uncertainties, and the paper distinguishes between established results (e.g., Mercury's perihelion advance) and active research frontiers (e.g., tests of quantum gravity). The conclusion follows directly from the evidence presented, without overstatement or speculation beyond what the sources support.
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{attachments/image}
	...
	The empirical success of general relativity is extraordinary by any standard. Within the solar system, the theory accounts for Mercury's 43 arcsecond-per-century perihelion advance with no adjustable parameters, predicts the bending of starlight to twice the Newtonian value—a result confirmed initially by Eddington's 1919 expedition and now measured to 0.03\% precision via VLBI—and explains gravitational redshift, verified from Pound-Rebka's tower experiment to Gravity Probe A's space-based maser measurements. Beyond the solar system, the theory's predictions become even more striking. The Hulse-Taylor binary pulsar's orbital decay matches the gravitational wave energy loss predicted by general relativity to better than 0.3%. The Laser Interferometer Gravitational-Wave Observatory (LIGO) has directly detected gravitational waves from merging black holes, with waveforms that exactly match numerical relativity solutions derived from the Einstein field equations. The Event Horizon Telescope has imaged the shadow of Sagittarius A*—a dark region whose diameter is consistent to within a few percent with the predicted photon ring around a supermassive black hole of roughly four million solar masses. And, on a scale that touches everyday life, the Global Positioning System must incorporate both special and general relativistic time dilation corrections of approximately 38 microseconds per day; without these corrections, GPS would accumulate positioning errors measured in kilometers within a single day.
	
	Yet for all its triumphs, general relativity cannot be the final word. The theory predicts its own failure at singularities—the centers of black holes and the initial moment of the Big Bang—where curvature becomes infinite and quantum effects must become dominant. A complete theory of quantum gravity remains elusive despite a century of effort. Moreover, astronomical observations reveal that approximately 85\% of the matter in the universe is dark matter, which does not interact electromagnetically, and approximately 68\% of the energy density is dark energy, which drives the accelerated expansion of the cosmos. General relativity provides no explanation for either phenomenon; it merely accommodates them as source terms in the Einstein field equations.
